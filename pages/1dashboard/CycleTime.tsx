...
<div className="bg-slate-950 rounded-xl text-gray-400">
  ...
  <div className="grid grid-cols-4 gap-8 p-8">
    ...
    <div className="alert is-info">
      <div className="alert-grid">
        <div className="u-flex u-gap-24 u-cross-center">
          <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="currentColor" className="bi bi-archive" viewBox="0 0 16 16">
      ...
      <div className="alert-grid">
        <div className="u-flex u-gap-24 u-cross-center">
          <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="currentColor" className="bi bi-box" viewBox="0 0 16 16">
            <path d="M8.186 1.113a.5.5 0 0 0-.372 0L1.846 3.5 8 5.961 14.154 3.5 8.186 1.113zM15 4.239l-6.5 2.6v7.922l6.5-2.6V4.24zM7.5 14.762V6.838L1 4.239v7.923l6.5 
                    2.6zM7.443.184a1.5 1.5 0 1 1 6.061-3.5 3.5 3.5 0 0 1-6.062 3.5z"/> 
          </svg>
    ...
    <div className="alert is-info">
      <div className="alert-grid">
        <div className="u-flex u-gap-24 u-cross-center">
          <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="currentColor" className="bi bi-tags" viewBox="0 0 16 16">
    ...
    <div className="alert is-info">
      <div className="alert-grid">
        <div className="u-flex u-gap-24 u-cross-center">
          <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="currentColor" className="bi bi-nut" viewBox="0 0 16 16">
