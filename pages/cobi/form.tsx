...
const Cobi: NextPage<IotProps & { brands: brand[]; noBrands: boolean }> = ({ iot, brands, noBrands }) => {
  ...
  const [selectedIot, setSelectedIot] = useState<IotType | null>(null);

  // Declare initialForm before using it
  const initialForm = selectedIot
    ? {
        id: selectedIot.id,
        devname: selectedIot.devname,
        devid: selectedIot.devid,
        devtype: selectedIot.devtype,
        deveui: selectedIot.deveui,
        brandId: selectedIot.brandId, // Convert to string
      }
    : {
        id: '',
        devname: '',
  ...
  const handleEdit = (iotItem: IotType) => {
    setSelectedIot(iotItem);
    setForm({
      id: iotItem.id,
      devname: iotItem.devname,
      devid: iotItem.devid,
      devtype: iotItem.devtype,
      deveui: iotItem.deveui,
      brandId: iotItem.brandId.toString(), // Convert to string
    });
    setNewIot(false);
    nextStep();
  };
        ...
        <form
          ...
          onSubmit={(e) => {
            ...
            if (form.devname && form.devid) {
              ...
              alert("Please fill in IOT Name and ID fields.");
            }
          }}
        >
