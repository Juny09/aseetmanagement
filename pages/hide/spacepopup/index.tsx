...
const Home: NextPage<Spaces> = ({ spaces }) => {
  ...
  async function updateSpace(id: string, lid: string, country: string, state: string, area: string, building: string,
     floor: string, zone: string, dimensions: string, areasq: string, occupancy: string, spacetype: string, purposeusage: string) {
    ...
    if (spaceToUpdate) {
      setForm({
        id: spaceToUpdate.id,
        lid: spaceToUpdate.lid,
        country: spaceToUpdate.country,
        state: spaceToUpdate.state,
        area: spaceToUpdate.area,
        building: spaceToUpdate.building,
        floor: spaceToUpdate.floor,
        zone: spaceToUpdate.zone,
        dimensions: spaceToUpdate.dimensions,
        areasq: spaceToUpdate.areasq,
        occupancy: spaceToUpdate.occupancy,
        spacetype: spaceToUpdate.spacetype,
        purposeusage: spaceToUpdate.purposeusage,
      });
