...
{step === 2 && (
  <form
    ...
    onSubmit={e => {
      e.preventDefault();
      if (form.name && form.idp && form.quantity) {
        // Proceed with the submission
  ...
  >
    ...
    <div className="field field_v1">
      ...
      <input type="text" placeholder="Enter Part ID" 
        value={form.idp} 
    ...
    <div className="field field_v1">
      ...
      <textarea
        ...
        className="field__input block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
      />
      <span className="absolute inset-0 pointer-events-none cursor-text field__label-wrap">
